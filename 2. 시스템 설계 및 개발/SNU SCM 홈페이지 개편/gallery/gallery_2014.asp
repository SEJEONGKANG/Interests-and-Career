...
<html lang="ko">
  ...
  <body>
    ...
    <section class="gallery-section standard-section">
      ...
      <div class="row">
        <div class="column">
          <img src="/src/gallery/14/8.jpg" onclick="expandImage(this);" />
        </div>
        <div class="column">
          <img src="/src/gallery/14/9.jpg" onclick="expandImage(this);" />
        </div>
      </div>
    ...
    <section class="gallery-section standard-section">
      <div class="section-header">
        <h2>2014 춘계 KIIE 학술대회</h2>
      </div>

      <div class="row">
        <div class="column">
          <img src="/src/gallery/14/4.jpg" onclick="expandImage(this);" />
        </div>
        <div class="column">
          <img src="/src/gallery/14/5.jpg" onclick="expandImage(this);" />
        </div>
        <div class="column">
          <img src="/src/gallery/14/2.jpg" onclick="expandImage(this);" />
        </div>
        <div class="column">
          <img src="/src/gallery/14/1.jpg" onclick="expandImage(this);" />
        </div>
        <div class="column">
          <img src="/src/gallery/15/5.jpg" onclick="expandImage(this);" />
        </div>
      </div>
    ...
    <section class="gallery-section standard-section">
      <div class="section-header">
        <h2>2014 APMS Gala Dinner</h2>
      </div>

      <img src="/src/gallery/15/10.jpg" style="width: 80vh" />
    </section>
    ...
    <section class="gallery-section standard-section">
      ...
      <div class="row">
        <div class="column">
          <img src="/src/gallery/14/3.jpg" onclick="expandImage(this);" />
        </div>
        <div class="column">
          <img src="/src/gallery/14/0.jpg" onclick="expandImage(this);" />
        </div>
      </div>
